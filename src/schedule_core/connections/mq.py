...
class RabbitMQManager:
    ...
    def __init__(self):
        """初始化 RabbitMQ 管理器，每次创建新实例都有独立的连接"""
    ...
    def _initialize(self):
        ...
        self._connection_params = pika.ConnectionParameters(
            ...
            blocked_connection_timeout=settings
    ...
    def get_exchange_type(self, exchange_type_name: str) -> ExchangeType:
        ...
        return exchange_types.get(exchange_type_name.lower(),
                                  ExchangeType.direct)
    ...
    def publish_message(
        ...
        try:
            ...
            message_body = (
                message.encode()
                if isinstance(message, str) else json.dumps(message).encode())
